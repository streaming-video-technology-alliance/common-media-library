	...
	it('should write a SampleDescriptionBox correctly', function () {
		...
		const box = {
			...
			entries: [{
				...
				esds: new Uint8Array([0, 0, 0, 50, 101, 115, 100, 115, 0, 0, 0, 0, 3, 128, 128, 34, 0, 0, 0, 4, 128, 128, 22, 64, 21, 0, 32, 0, 0, 1, 244, 0, 0, 1, 244, 0, 5, 128, 128, 5, 17, 144, 0, 0, 0, 6, 128, 128, 1, 2]),
				preDefined: 65534,
		...
		assert.strictEqual(Buffer.compare(buffer, new Uint8Array([
			...
			0, 2, // preDefined
			0, 16, // reserved3
			255, 254, 0, 0, // samplerate
			187, 128, 0, 0, 0, 0, 0, 50, 101, 115, 100, 115, 0, 0, 0, 0, 3, 128, 128, 34, 0, 0, 0, 4, 128, 128, 22, 64, 21, 0, 32, 0, 0, 1, 244, 0, 0, 1, 244, 0, 5, 128, 128, 5, 17, 144, 0, 0, 0, 6, 128, 128, 1, 2
		])), 0)
		// #endregion example
	})
})
