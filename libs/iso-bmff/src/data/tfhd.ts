 ...
 */
export class tfhd extends FullBoxBase<TrackFragmentHeaderBox> {
	...
	static read(view: IsoView): TrackFragmentHeaderBox {
		...
		return new tfhd(trackId, baseDataOffset, sampleDescriptionIndex, defaultSampleDuration, defaultSampleSize, defaultSampleFlags, version, flags)
	}
	...
	override get size(): number {
		// 4 (trackId) + optional fields based on flags
		let size = 4
