...
export class TrackHeaderBox extends FullBox {
	...
	write(dataView: DataView, offset: number = 0): number {
		...
		cursor += timeSize
		writeUint(dataView, cursor, 4, this.trackId)
		cursor += 4
		writeUint(dataView, cursor, 4, this.reserved1)
		cursor += 4
		...
		writeInt(dataView, cursor, 2, this.layer)
		cursor += 2
		writeInt(dataView, cursor, 2, this.alternateGroup)
		cursor += 2
		writeInt(dataView, cursor, 2, this.volume)
		cursor += 2
		writeUint(dataView, cursor, 2, this.reserved3)
		cursor += 2
		...
		writeUint(dataView, cursor, 4, this.width)
		cursor += 4
		writeUint(dataView, cursor, 4, this.height)
		cursor += 4
