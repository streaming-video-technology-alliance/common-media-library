...
function find<T extends IsoBox = IsoBox>(iterator: Iterable<IsoBox>, recursive: boolean, fn: IsoBoxFilter<T>): T | null {
 ...
 * @public
 */
export function findIsoBox<T extends IsoBox = IsoBox>(
	raw: IsoBoxData | Iterable<IsoBox>,
	fn: IsoBoxFilter<T>,
