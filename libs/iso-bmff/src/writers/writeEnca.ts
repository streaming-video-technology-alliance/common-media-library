...
/**
 * Write an AudioSampleEntryBox (enca) to a Uint8Array.
 *
 ...
 * @beta
 */
export function writeEnca(box: Fields<AudioSampleEntryBox<'enca'>>): Uint8Array {
	const headerSize = 8
	...
	let offset = 0
	offset += writeBoxHeader(dataView, offset, 'enca', totalSize)
