...
import { readAvc2 } from '../readers/readAvc2.ts'
import { writeAvc2 } from '../writers/writeAvc2.ts'
import type { Fields } from './types/Fields.ts'
import type { VisualSampleEntryBox } from './types/VisualSampleEntryBox.ts'

/**
 * Visual Sample Entry Box (avc2)
 *
 * @public
 */
export class avc2 implements Fields<VisualSampleEntryBox<'avc2'>> {
	...
	static write(fields: Fields<VisualSampleEntryBox<'avc2'>>): IsoBoxWriteView {
		return writeAvc2(fields)
	}

	/**
	 * Read a VisualSampleEntryBox (avc2) from an IsoBoxReadView.
	 *
	 * @param view - The IsoBoxReadView to read data from
	 *
	 * @returns A parsed VisualSampleEntryBox (avc2)
	 */
	static read(view: IsoBoxReadView): Fields<VisualSampleEntryBox<'avc2'>> {
		return readAvc2(view)
	}
	...
	/**
	 * Create a new VisualSampleEntryBox (avc2).
	 *
