...
import { readAvc1 } from '../readers/readAvc1.ts'
import { writeAvc1 } from '../writers/writeAvc1.ts'
import type { Fields } from './types/Fields.ts'
import type { VisualSampleEntryBox } from './types/VisualSampleEntryBox.ts'

/**
 * Visual Sample Entry Box (avc1)
 *
 * @public
 */
export class avc1 implements Fields<VisualSampleEntryBox<'avc1'>> {
	/**
	 * Write a VisualSampleEntryBox (avc1) to an IsoBoxWriteView.
	 *
	...
	static write(fields: Fields<VisualSampleEntryBox<'avc1'>>): IsoBoxWriteView {
		return writeAvc1(fields)
	}

	/**
	 * Read a VisualSampleEntryBox (avc1) from an IsoBoxReadView.
	 *
	 * @param view - The IsoBoxReadView to read data from
	 *
	 * @returns A parsed VisualSampleEntryBox (avc1)
	 */
	...
	/**
	 * Create a new VisualSampleEntryBox (avc1).
	 *
