...
import { readAvc3 } from '../readers/readAvc3.ts'
import { writeAvc3 } from '../writers/writeAvc3.ts'
import type { Fields } from './types/Fields.ts'
import type { VisualSampleEntryBox } from './types/VisualSampleEntryBox.ts'

/**
 * Visual Sample Entry Box (avc3)
 *
 * @public
 */
export class avc3 implements Fields<VisualSampleEntryBox<'avc3'>> {
	...
	static write(fields: Fields<VisualSampleEntryBox<'avc3'>>): IsoBoxWriteView {
		return writeAvc3(fields)
	}

	/**
	 * Read a VisualSampleEntryBox (avc3) from an IsoBoxReadView.
	 *
	 * @param view - The IsoBoxReadView to read data from
	 *
	 * @returns A parsed VisualSampleEntryBox (avc3)
	 */
	static read(view: IsoBoxReadView): Fields<VisualSampleEntryBox<'avc3'>> {
		return readAvc3(view)
	}
	...
	/**
	 * Create a new VisualSampleEntryBox (avc3).
	 *
