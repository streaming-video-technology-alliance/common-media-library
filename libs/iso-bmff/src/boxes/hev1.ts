...
import { readHev1 } from '../readers/readHev1.ts'
import { writeHev1 } from '../writers/writeHev1.ts'
import type { Fields } from './types/Fields.ts'
import type { VisualSampleEntryBox } from './types/VisualSampleEntryBox.ts'

/**
 * Visual Sample Entry Box (hev1)
 *
 * @public
 */
export class hev1 implements Fields<VisualSampleEntryBox<'hev1'>> {
	...
	static write(fields: Fields<VisualSampleEntryBox<'hev1'>>): IsoBoxWriteView {
		return writeHev1(fields)
	}

	/**
	 * Read a VisualSampleEntryBox (hev1) from an IsoBoxReadView.
	 *
	 * @param view - The IsoBoxReadView to read data from
	 *
	 * @returns A parsed VisualSampleEntryBox (hev1)
	 */
	static read(view: IsoBoxReadView): Fields<VisualSampleEntryBox<'hev1'>> {
		return readHev1(view)
	}
	...
	/**
	 * Create a new VisualSampleEntryBox (hev1).
	 *
