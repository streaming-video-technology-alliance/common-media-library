...
import { readHvc1 } from '../readers/readHvc1.ts'
import { writeHvc1 } from '../writers/writeHvc1.ts'
import type { Fields } from './types/Fields.ts'
import type { VisualSampleEntryBox } from './types/VisualSampleEntryBox.ts'

/**
 * Visual Sample Entry Box (hvc1)
 *
 * @public
 */
export class hvc1 implements Fields<VisualSampleEntryBox<'hvc1'>> {
	...
	static write(fields: Fields<VisualSampleEntryBox<'hvc1'>>): IsoBoxWriteView {
		return writeHvc1(fields)
	}

	/**
	 * Read a VisualSampleEntryBox (hvc1) from an IsoBoxReadView.
	 *
	 * @param view - The IsoBoxReadView to read data from
	 *
	 * @returns A parsed VisualSampleEntryBox (hvc1)
	 */
	static read(view: IsoBoxReadView): Fields<VisualSampleEntryBox<'hvc1'>> {
		return readHvc1(view)
	}
	...
	/**
	 * Create a new VisualSampleEntryBox (hvc1).
	 *
