 ...
 *
 * Spec-valid codes exist outside this union. HTTP response status codes
 * embed into the Network category (3100-3599), and Publisher-defined
 * codes occupy the Custom category (99001-99999). APIs that accept
 * open-ended SVTA error codes should accept `number`.
 *
 * @public
 */
