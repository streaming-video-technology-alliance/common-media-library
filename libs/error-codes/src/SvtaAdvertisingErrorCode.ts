 ...
 * 999. `7301` is VAST error 301. See `vastErrorToSvtaErrorCode`.
 * VAST defines no error 404, so there is no `7404`. The four-digit VAST
 * error 1009 (empty VAST response) maps to `7999`.
 *
