...
describe('vastErrorToSvtaErrorCode', () => {
	...
	it('maps the four-digit VAST error 1009 to the empty VAST response code', () => {
		strictEqual(vastErrorToSvtaErrorCode(1009), 7999)
		strictEqual(vastErrorToSvtaErrorCode(1009), SvtaAdvertisingErrorCode.EMPTY_VAST_RESPONSE)
	})
	...
	it('returns the unknown advertising code for values outside the VAST range', () => {
		...
		strictEqual(vastErrorToSvtaErrorCode(1008), SvtaAdvertisingErrorCode.UNKNOWN)
		strictEqual(vastErrorToSvtaErrorCode(1010), SvtaAdvertisingErrorCode.UNKNOWN)
