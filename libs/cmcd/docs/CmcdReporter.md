...
```typescript
import { CmcdReporter, CmcdEventType, CMCD_QUERY, CMCD_V2 } from '@svta/cml-cmcd'
...
| `enabledKeys` | `CmcdKey[]` | `undefined` | Keys to include in reports |
...
| `events` | `CmcdEventType[]` | Required | Events to report |
...
| `enabledKeys` | `CmcdKey[]` | `undefined` | Keys to include for this target |
