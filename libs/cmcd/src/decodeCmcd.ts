 ...
 *
 * @see {@link https://cta-wave.github.io/Resources/common-media-client-data--cta-5004-a.html#payload-definition-for-headers-and-query-argument-transmission | CTA-5004-A Payload Definition}
 *
 * @public
 *
 * @example
