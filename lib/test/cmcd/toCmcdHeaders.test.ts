import type { CmcdCustomKey, CmcdHeaderMap } from '@svta/common-media-library/cmcd';
import { CmcdHeaderField, CmcdReportingMode, toCmcdHeaders } from '@svta/common-media-library/cmcd';
