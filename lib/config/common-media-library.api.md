...
// Warning: (ae-forgotten-export) The symbol "IHam" needs to be exported by the entry point index.d.ts
// Warning: (ae-forgotten-export) The symbol "IVisitorElement" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
