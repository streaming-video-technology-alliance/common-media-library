import type { Cta608Packet } from './Cta608Packet';
import type { Cta708Byte } from './Cta708Byte';
 ...
 * @export
 */
export class CtaDecoder {
	/**
	 * An array of CTA-608 closed caption data extracted for decoding.
	 */
	private cea608DataArray_: Cta608Packet[] = [];

	/**
	 * An array of CEA-708 closed caption data extracted for decoding.
	 */
	private cea708DataArray_: Cta708Byte[] = [];

	/**
	 * Number of consecutive bad frames decoded on CTA-608.
	 */
	private badFrames_ = 0;

	/**
	 * The current channel that is active on CEA-608 field 1.
	 */
	private currentField1Channel_ = 0;

	/**
	 * The current channel that is active on CEA-608 field 2.
	 */
	private currentField2Channel_ = 0;

	/**
	 */
	private waitingForFirstPacket_ = true;

	/**
	 * Set used to track available streams.
	 */
	private streams_: Set<string> = new Set();
