...
ISOBox.prototype._boxProcessors['mdhd'] = function () {
	this._procFullBox();
	this._procField('creation_time', 'uint', (this.version == 1) ? 8 : 4);
	this._procField('modification_time', 'uint', (this.version == 1) ? 8 : 4);
	this._procField('timescale', 'uint', 32);
	this._procField('duration', 'uint', (this.version == 1) ? 8 : 4);
